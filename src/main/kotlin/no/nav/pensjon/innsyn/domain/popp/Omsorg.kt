...
@SecondaryTables(
        ...
        SecondaryTable(name = "T_K_OMSORG_T", pkJoinColumns = [PrimaryKeyJoinColumn(name = "K_OMSORG_T")]),
        SecondaryTable(name = "T_K_OMSORG_S", pkJoinColumns = [PrimaryKeyJoinColumn(name = "K_OMSORG_S")])
)
data class Omsorg(
        @Column(name = "AR")
        val ar: Int,
