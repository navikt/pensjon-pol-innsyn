INSERT INTO T_BEHOLDNING(person_id, inntekt_opptj_id, f_tjen_opptj_id, dagpenger_opptj_id, omsorg_opptj_id,
...
VALUES (1, 1, 1, 1, 1, 1, 1, 'k_beholdning_t', 'k_beholdning_s', 'k_restp_beh_arsak', TO_DATE('2019.11.01', 'YYYY.MM.DD'), TO_DATE('2019.12.31', 'YYYY.MM.DD'), 1.23,
        2.34, 3.45, 4.56);

INSERT INTO T_DAGPENGER(person_id, ferietillegg, barnetillegg, dagpenger, uavkortet_dp_grlag, ar, k_dagpenger_t,
...
INSERT INTO T_F_TJEN_TOT(person_id, dato_tjenestestart, dato_dimittering, k_kilde_t, k_rapport_t, k_f_tjen_tot_s)
VALUES (1, TO_DATE('2019.12.31', 'YYYY.MM.DD'), TO_DATE('2019.12.31', 'YYYY.MM.DD'), 'k_kilde_t', 'k_rapport_t', 'k_f_tjen_tot_s');

INSERT INTO T_FPP_AFP(k_fpp_afp_s, person_id, afp_fpp, afp_pensjonsgrad, afp_type, virk_fom, virk_tom)
VALUES (1, 1, 123.45, 32.1, 'AFP 1', TO_DATE('2001.01.01', 'YYYY.MM.DD'), TO_DATE('2029.12.31', 'YYYY.MM.DD'));
...
INSERT INTO T_OPPTJN(person_id_opptjn, opptjn_ar, pgi_anvendt, poeng, max_uforegrad, k_opptjn_t, k_opptjn_status,
                     k_kilde_t)
